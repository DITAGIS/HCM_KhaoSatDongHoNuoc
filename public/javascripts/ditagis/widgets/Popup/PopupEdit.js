define([
...
], function (on, dom, domConstruct, Point, LocateViewModel, FeatureLayer, FeatureTable,
  ...
  return class {
    constructor(view, options) {
      ...
      this.inputElement = {};
      this.tableData = new FeatureTable({
    ...
    isValidDanhBo(id) {
      return new Promise((resolve, reject) => {
        this.tableData.findById(id).then(function (results) {
